...
- V3 hub impacts emit 1–3 child signals total; rare terminal-growth signals reserve a unique free dendrite, travel its live curve, and grow a persistent child shell at the tip while the dendrite morphs from pointed to membrane-connected
